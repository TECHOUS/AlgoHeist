...
int main()
{
    string keys[] = {"trie", "hacktober", "contributor"};
    ...
    cout << "\n----------------------------------------------------------------------";
    cout << "\n\n";
    search(root, "hacktober") ? cout << "Key [hacktober] present in Trie\n" : cout << "key [hacktober] is Not present \n\n";
    search(root, "hack") ? cout << "Key [hack] present in trie\n" : cout << "key [hack]  is not present \n\n";
    cout << "\n\n";
    cout << "----------------------------------------------------------------------\n\n";
    return 0;
}
