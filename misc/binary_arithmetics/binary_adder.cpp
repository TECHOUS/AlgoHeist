...
uint16_t b8_adder(uint8_t a,uint8_t b)
{
 uint16_t total16=0;
 total16=a+b;
 uint16_t rem=(total16>>8);
 uint16_t total8=(total16);
 uint16_t real_total=(total8+rem);
 return real_total;
}
...
uint16_t b32_adder(uint32_t a,uint32_t b)
{
 ...
 uint64_t total64=0;
 total64=a+b;
 uint16_t rem=(total64>>32);
 uint16_t total32=(total64);
 uint16_t real_total=(total32+rem);
 return real_total;
}